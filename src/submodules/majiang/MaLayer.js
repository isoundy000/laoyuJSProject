...
(function (exports) {
    ...
    var MaLayer = cc.Layer.extend({
        ...
        onPlayerEnterExit: function () {
            ...
            //邀请俱乐部成员
            if (this.getRoomState() == ROOM_STATE_ONGOING || players.length >= playerNum) {
        ...
        ctor: function (_data, _isReplay) {
            ...
            loadNodeCCS(res.MaScene_json, this, "Scene");
        ...
        setPai: function (row, idx, val, isLittle, isStand, isVisible) {
            ...
            if ((mapId == MAP_ID.ZHUANZHUAN || mapId == MAP_ID.HONGZHONG) && gameData.playerNum >= 2) {
        ...
        setPaiArrOfRow: function (row, paiArr, isLittle, isStand, liangPaiArr, liangAll, huPaiId) {
            ...
            if (mapId == MAP_ID.ZHUANZHUAN || mapId == MAP_ID.HONGZHONG) {
