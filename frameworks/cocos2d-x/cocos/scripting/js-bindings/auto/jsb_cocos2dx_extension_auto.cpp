...
bool js_cocos2dx_extension_ScrollView_getDeaccelerateEnable(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::ScrollView* cobj = (cocos2d::extension::ScrollView *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_ScrollView_getDeaccelerateEnable : Invalid Native Object");
    if (argc == 0) {
        bool ret = cobj->getDeaccelerateEnable();
        JS::RootedValue jsret(cx);
        jsret = BOOLEAN_TO_JSVAL(ret);
        args.rval().set(jsret);
        return true;
    ...
    JS_ReportError(cx, "js_cocos2dx_extension_ScrollView_getDeaccelerateEnable : wrong number of arguments: %d, was expecting %d", argc, 0);
    return false;
}
...
bool js_cocos2dx_extension_ScrollView_deaccelerateScrollingEnd(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::ScrollView* cobj = (cocos2d::extension::ScrollView *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_ScrollView_deaccelerateScrollingEnd : Invalid Native Object");
    if (argc == 0) {
        cobj->deaccelerateScrollingEnd();
        args.rval().setUndefined();
        return true;
    }

    JS_ReportError(cx, "js_cocos2dx_extension_ScrollView_deaccelerateScrollingEnd : wrong number of arguments: %d, was expecting %d", argc, 0);
    return false;
}
...
bool js_cocos2dx_extension_ScrollView_setDeaccelerateEnable(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::ScrollView* cobj = (cocos2d::extension::ScrollView *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_ScrollView_setDeaccelerateEnable : Invalid Native Object");
    if (argc == 1) {
        bool arg0;
        arg0 = JS::ToBoolean(args.get(0));
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_extension_ScrollView_setDeaccelerateEnable : Error processing arguments");
        cobj->setDeaccelerateEnable(arg0);
        args.rval().setUndefined();
        return true;
    }

    JS_ReportError(cx, "js_cocos2dx_extension_ScrollView_setDeaccelerateEnable : wrong number of arguments: %d, was expecting %d", argc, 1);
    return false;
}
...
void js_register_cocos2dx_extension_ScrollView(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec funcs[] = {
        ...
        JS_FN("getDeaccelerateEnable", js_cocos2dx_extension_ScrollView_getDeaccelerateEnable, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        ...
        JS_FN("deaccelerateScrollingEnd", js_cocos2dx_extension_ScrollView_deaccelerateScrollingEnd, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("setZoomScale", js_cocos2dx_extension_ScrollView_setZoomScale, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FN("setDeaccelerateEnable", js_cocos2dx_extension_ScrollView_setDeaccelerateEnable, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
