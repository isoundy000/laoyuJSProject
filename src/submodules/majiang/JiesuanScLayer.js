(function () {
    ...
    var JiesuanScLayer = cc.Layer.extend({
        myInitTaxIdx: -1,
        curTabIdx: -1,
        curSum: 0,
        pos: null,
        ...
        ctor: function (data) {
            ...
            TouchUtils.setOnclickListener($('root.panel.bg.player_3'), function () {
                that.curTabIdx = 3;
                that.getOnePlayerData(that._playerid[3]);
                // $('root.panel.bg.player_0').setTexture(t2);
                // $('root.panel.bg.player_1').setTexture(t2);
                // $('root.panel.bg.player_2').setTexture(t2);
                // $('root.panel.bg.player_3').setTexture(t1);
                for (var index = 0; index < 4; ++index) {
                    $('root.panel.bg.player_' + index + '_s').setVisible(index == that.curTabIdx);
                }
            });
            ...
            if(data.players.length == 2){
                $('root.panel.bg.player_2').setVisible(false);
                $('root.panel.bg.player_3').setVisible(false);
                $('root.panel.bg.player_1.Sprite_9').setTexture('res/submodules/majiang/image/ma_sc/jisuan/jiesuan_dj.png');
            }
        ...
        createCell: function (cell, idx) {
            var FONT_SIZE = 24;
            var FONT_COLOR = cc.color(0, 0, 0);
            var OUTLINE_COLOR = cc.color(45, 45, 45);

            // var cellbg = duplicateSprite($('root.panel.bg.detail_cellbg'),false);
            ...
            caozuo.setFontSize(FONT_SIZE);
            caozuo.setTextColor(FONT_COLOR);
            // caozuo.enableOutline(OUTLINE_COLOR, 1);
            ...
            fanshu.setFontSize(FONT_SIZE);
            fanshu.setTextColor(FONT_COLOR);
            // fanshu.enableOutline(OUTLINE_COLOR, 1);
            fanshu.setPosition(cc.p(265, 30));
            cell.addChild(fanshu);
            //上家
            var shangjia = new ccui.Text();
            shangjia.setName('shangjia');
            shangjia.setFontSize(FONT_SIZE);
            shangjia.setTextColor(FONT_COLOR);
            // shangjia.enableOutline(OUTLINE_COLOR, 1);
            shangjia.setPosition(cc.p(380, 30));
            cell.addChild(shangjia);
            //对家
            var duijia = new ccui.Text();
            duijia.setName('duijia');
            duijia.setFontSize(FONT_SIZE);
            duijia.setTextColor(FONT_COLOR);
            // duijia.enableOutline(OUTLINE_COLOR, 1);
            duijia.setPosition(cc.p(517, 30));
            cell.addChild(duijia);
            //下家
            var xiajia = new ccui.Text();
            xiajia.setName('xiajia');
            xiajia.setFontSize(FONT_SIZE);
            xiajia.setTextColor(FONT_COLOR);
            // xiajia.enableOutline(OUTLINE_COLOR, 1);
            xiajia.setPosition(cc.p(665, 30));
            cell.addChild(xiajia);
            //合计
            var heji = new ccui.Text();
            heji.setName('heji');
            heji.setFontSize(FONT_SIZE);
            heji.setTextColor(FONT_COLOR);
            // heji.enableOutline(OUTLINE_COLOR, 1);
        ...
        updateTableHeader: function () {
            ...
            if (this.curTabIdx == 0) {
                ...
                dj.setPositionX(this.pos[1]);
                xj.setPositionX(this.pos[2]);
                sj.setVisible(true);
                dj.setVisible(true);
                xj.setVisible(true);
                // s0.setTexture(cc.textureCache.addImage('res/table/jisuan/js_sj.png'));
                // s1.setTexture(cc.textureCache.addImage('res/table/jisuan/js_dj.png'));
                // s2.setTexture(cc.textureCache.addImage('res/table/jisuan/js_xj.png'));
            }
            else if (this.curTabIdx == 1) {
                me.setPositionX(this.pos[0]);
                sj.setPositionX(this.pos[1]);
                dj.setPositionX(this.pos[2]);
                me.setVisible(true);
                sj.setVisible(true);
                dj.setVisible(true);
                ...
                // s2.setTexture(cc.textureCache.addImage('res/table/jisuan/js_dj.png'));
            }
            else if (this.curTabIdx == 2) {
                xj.setPositionX(this.pos[0]);
                me.setPositionX(this.pos[1]);
                sj.setPositionX(this.pos[2]);
                xj.setVisible(true);
                me.setVisible(true);
                sj.setVisible(true);
                ...
                // s2.setTexture(cc.textureCache.addImage('res/table/jisuan/js_sj.png'));
            }
            else if (this.curTabIdx == 3) {
                dj.setPositionX(this.pos[0]);
                xj.setPositionX(this.pos[1]);
                me.setPositionX(this.pos[2]);
                dj.setVisible(true);
                xj.setVisible(true);
                me.setVisible(true);
                //     s0.setTexture(cc.textureCache.addImage('res/table/jisuan/js_dj.png'));
                //     s1.setTexture(cc.textureCache.addImage('res/table/jisuan/js_xj.png'));
                //     s2.setTexture(cc.textureCache.addImage('res/table/jisuan/js_me.png'));
            }
        },
    ...
    exports.JiesuanScLayer = JiesuanScLayer;
})(window);
