...
(function () {
    ...
    var PokerJBCZongJiesuanLayer = cc.Layer.extend({
        onEnter: function () {
            this._super();
        ...
        ctor: function (data) {
            ...
            var scene = loadNodeCCS(res.PokerJBCZongJieSuan_json, this);
    ...
    exports.PokerJBCZongJiesuanLayer = PokerJBCZongJiesuanLayer;
})(window);
