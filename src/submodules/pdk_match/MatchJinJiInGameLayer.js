...
(function(){
    var $=null;
    var exports=this;
    var MatchJinJiInGameLayer=cc.Layer.extend(
        {
            ctor:function(curstage,totalstage,data){
                ...
                var scene=loadNodeCCS(res.MatchPromotionInGameLayer_json,this);
    ...
    exports.MatchJinJiInGameLayer = MatchJinJiInGameLayer;
