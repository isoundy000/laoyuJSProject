...
(function (exports) {
    ...
    var TEXTURE_STATUS = {
        'kan': cc.textureCache.addImage("res/image/ui/poker/unit/yikanpai.png"),
        'qi': cc.textureCache.addImage("res/image/ui/poker/unit/yiqipai.png"),
        'shu': cc.textureCache.addImage("res/image/ui/poker/unit/bipaishu.png")
    };
    var BatteryTextures = {
    ...
    for (var i = 0; i < 54; i++)
        PAIID2CARD[i] = new pokerRule_pdk.Card(i);
    ...
    var SHENFEN_TEXTURE = {};
    SHENFEN_TEXTURE["dizhu_l"] = cc.textureCache.addImage("res/image/ui/poker/character/dizhu_l.png");
    SHENFEN_TEXTURE["dizhu_r"] = cc.textureCache.addImage("res/image/ui/poker/character/dizhu_r.png");
    SHENFEN_TEXTURE["nongmin_l"] = cc.textureCache.addImage("res/image/ui/poker/character/nongmin_l.png");
    SHENFEN_TEXTURE["nongmin_r"] = cc.textureCache.addImage("res/image/ui/poker/character/nongmin_r.png");
    ...
    var PokerLayer = cc.Layer.extend({
        ...
        onCCSLoadFinish: function () {
            ...
            network.addListener(3002, function (data) {
                ...
                pokerRule_pdk.changeAvailableCardTypes(gameData.mapId);
            });
            ...
            network.addListener(4503, function (data) {
                ...
                if (!isReplay) {
                    if (row == 2) {
                        if (cardtype && cardtype != '') {
                            ...
                            $('row2.cardtype').loadTexture('res/image/ui/poker/character/cardtype' + cardtype + '.png');
                        } else {
                ...
                if (QI) {
                    ...
                    for (var i = 0; i < 3; i++) {
                        $('row' + row + 'b.b' + i).setTexture('res/image/ui/poker/unit/pai_backold.png');
                    }
                    ...
                    that.biPaiAnim(row, uid2position[data['win_uid']], uid2position[data['lose_uid']], function () {
                        ...
                        if (!isReplay) {
                            ...
                            if (_.isArray(data['pai_arr']) && data['pai_arr'].length > 0) {
                                ...
                                $('row2.cardtype').setVisible(true);
                                $('row2.cardtype').loadTexture('res/image/ui/poker/character/cardtype' + data.card_type + '.png');
                                if (uid2position[data['lose_uid']] == 2) {
                                    setTimeout(function () {
                                ...
                                if (data.pai_arr.hasOwnProperty(_uid) && _uid && _uid != '0') {
                                    ...
                                    if (_row) {
                                        ...
                                        (function (__row, __uid) {
                                            ...
                                            $('row' + __row + '.cardtype').loadTexture('res/image/ui/poker/character/cardtype' + data.pai_arr[__uid].cardtype + '.png');
                                        })(_row, _uid);
                                    }
                                }
                            }
        ...
        changeBg: function (sceneid) {
            ...
            // $('bg').setTexture('res/submodules/pdk/image/PkScene/table_back' + sceneid + '.jpg');
        },
        ...
        ctor: function (_data, _isReplay) {
            ...
            if (gameData.mapId == MAP_ID.PDK || gameData.mapId == MAP_ID.PDK_JBC || gameData.mapId == MAP_ID.PDK_MATCH) {
                loadNodeCCS(res.PkScene_pdk_json, this, "Scene");
            }
        ...
        setPaiHua: function (pai, val, row) {
            ...
            if (paiid == 0) {
                ...
                if (val >= 0) {
                    //setPokerFrameByName(a, (originValue == null && !pokerRule_pdk.isLaizi(val, laiziValue)) ? arr[0] : "b/orange_" + val % 13 + ".png");
                ...
                if (originValue != null) {
                    ...
                    b.setVisible(false);
                    c.setVisible(false);
                } else if (pokerRule_pdk.isLaizi(val, laiziValue)) {
                    if (originValueFrame) {
                ...
                if (val == -1) {
                    pai.setTexture('res/submodules/pdk/image/PkScene/pai_back3.png');
                } else {
                ...
                if (roomState == ROOM_STATE_ONGOING) {
                    if (mapId != MAP_ID.ZJH) {
                        ...
                        for (var chipnum = 0; chipnum < data['chips'].length; chipnum++) {
                            (function (chipnum) {
                                var chip = new cc.Sprite(cc.textureCache.addImage('res/image/ui/poker/unit/chip' + data['chips'][chipnum] + '.png'));
        ...
        chuPai: function (row, paiArr, leftPaiCnt) {
            ...
            if (false) ;
                ...
                var cardType = pokerRule_pdk.judgeType(paiArr);
                if (paiArr.length > 0)
                    var pai_for_voice = paiArr[0] < 100 ? paiArr[0] : (Math.floor(paiArr[0] / 100) - 1);
                if (cardType == pokerRule_pdk.CardType.c1)
                    playEffect("v" + PAIID2CARD[pai_for_voice].voice, position2sex[row]);
                else if (cardType == pokerRule_pdk.CardType.c2)
                    playEffect("vpair" + PAIID2CARD[pai_for_voice].voice, position2sex[row]);
                else if (cardType == pokerRule_pdk.CardType.c3) {
                    playEffect("vthree_one", position2sex[row]);
                    setTimeout(function () {
                        playEffect("v" + PAIID2CARD[pai_for_voice].voice, position2sex[row]);
                    }, 600);
                }
                else if (cardType == pokerRule_pdk.CardType.c4 || cardType == pokerRule_pdk.CardType.c42 ||
                    (cardType == pokerRule_pdk.CardType.c3A && (gameData.pdk3Abomb || gameData.pdk3A1bomb)) ||
                    (cardType == pokerRule_pdk.CardType.c3A1 && gameData.pdk3A1bomb)) {
                ...
                else if (cardType == pokerRule_pdk.CardType.c1122) {
                    playEffect("vcontinuous_pair", position2sex[row]);
                    playEffect("vcom_continuous_pair");
                }
                else if (cardType == pokerRule_pdk.CardType.c31)
                    playEffect("vthree_with_one", position2sex[row]);
                else if (cardType == pokerRule_pdk.CardType.c32)
                    playEffect("vthree_with_one_pair", position2sex[row]);
                else if (cardType == pokerRule_pdk.CardType.c123) {
                    playEffect("vshunzi", position2sex[row]);
                    playEffect("vcom_shunzi");
                }
                else if (cardType == pokerRule_pdk.CardType.c11122234) {
                    playEffect("vaircraft_with_wings", position2sex[row]);
                    //that.playAircraftAnim();
                }
                else if (cardType == pokerRule_pdk.CardType.c111222) {
                    playEffect("vairplane", position2sex[row]);
                    //that.playAircraftAnim();
                }
                else if (cardType == pokerRule_pdk.CardType.c1112223344) {
                    playEffect("vaircraft_with_wings", position2sex[row]);
                    //that.playAircraftAnim();
                } else if (cardType == pokerRule_pdk.CardType.c4111) {//四代三音效
                    playEffect("vfour_with_three", position2sex[row]);
                }
            }
            switch (cardType) {
                case pokerRule_pdk.CardType.c1112223344:
                case pokerRule_pdk.CardType.c111222:
                case pokerRule_pdk.CardType.c11122234:
        ...
        checkCanChupai: function () {
            ...
            resultTypes = pokerRule_pdk.checkCards(curChuPaiUid == gameData.uid ? null : curChuPaiArr, chuPaiArr, isMyLastHandCards, laiziValue);
            if (gameData.mapId == MAP_ID.PDK || gameData.mapId == MAP_ID.PDK_JBC || gameData.mapId == MAP_ID.PDK_MATCH) {
                // for paodekuai
                if (pokerRule_pdk.judgeType(chuPaiArr) == pokerRule_pdk.CardType.c111222 && !(resultTypes.length > 0 && chuPaiArr.length == 6 && paiArr.length == 6))
                    resultTypes = [];
                if (pokerRule_pdk.judgeType(chuPaiArr) == pokerRule_pdk.CardType.c3 && !(resultTypes.length > 0 && chuPaiArr.length == 3 && paiArr.length == 3))
                    resultTypes = [];
                // if (pokerRule_pdk.judgeType(chuPaiArr) == pokerRule_pdk.CardType.c3A && !gameData.pdk3Abomb) {
                //     resultTypes = [];
                // }
                // if (pokerRule_pdk.judgeType(chuPaiArr) == pokerRule_pdk.CardType.c3A1 && !gameData.pdk3A1bomb) {
                //     resultTypes = [];
                // }

                //
                if (pokerRule_pdk.judgeType(chuPaiArr) == pokerRule_pdk.CardType.c3A && !gameData.pdk3Abomb && !gameData.pdk3A1bomb) {
                    resultTypes = [];
                }
                if (pokerRule_pdk.judgeType(chuPaiArr) == pokerRule_pdk.CardType.c3A1 && !gameData.pdk3A1bomb) {
                    resultTypes = [];
                ...
                if (pokerRule_pdk.judgeType(chuPaiArr) == pokerRule_pdk.CardType.c31 && chuPaiArr.length == 4 && paiArr.length == 4)
                    resultTypes = [{type: pokerRule_pdk.CardType.c31, cardArr: deepCopy(chuPaiArr)}];
            }
        ...
        upPaiByPaiArr: function (upPaiArr, tishiArr, idx) {
            ...
            if (gameData.mapId == MAP_ID.PDK || gameData.mapId == MAP_ID.PDK_JBC || gameData.mapId == MAP_ID.PDK_MATCH) {
                ...
                if (shangyijiaArr.length != 0) {
                    var paiType = pokerRule_pdk.judgeType(shangyijiaArr);
                    //单牌、对子、炸弹、顺子、跑得快连对
                    if (paiType == pokerRule_pdk.CardType.c1 || paiType == pokerRule_pdk.CardType.c2 || paiType == pokerRule_pdk.CardType.c4 || paiType == pokerRule_pdk.CardType.c123 || paiType == pokerRule_pdk.CardType.c1122) {
                        paiArr = pokerRule_pdk.toCardsArr(paiArr);
                        tishi = pokerRule_pdk.toCardsArr(tishi);
                        for (var i = 0; i < paiArr.length; i++) {
        ...
        enableChuPai: function () {
            ...
            var chupaiListener = cc.EventListener.create({
                ...
                onTouchEnded: function (touch, event) {
                    ...
                    if (slideOverCnt > 0) {
                        //关闭优先提示顺子
                        if(gameData.opt_conf.pdkchupaitishi && pokerRule && typeof pokerRule_pdk.automaticTip == 'function'){
                            //有之前滑起的牌  ，全部下去,重新选择
                            var upbefore = false;
                            for (var i = 0; i < initPaiNum; i++) {
                            ...
                            var cardlist = pokerRule_pdk.automaticTip(cardsArr, shangjiaPaiArr);
        ...
        slideTishiChupai: function () {
            ...
            if (valueArr.length >= 5) {
                ...
                if (curChuPaiArr && curChuPaiArr.length > 0) {
                    //上家去出了牌
                    var paiType = pokerRule_pdk.judgeType(curChuPaiArr);
                    if (paiType == pokerRule_pdk.CardType.c123 && curTishiArr.length >= 1) {
        ...
        setPaiArrOfRow: function (row, paiArr) {
            ...
            if (row == 1 || row == 3 || row == 20)
                paiArr.sort(function (a, b) {
                    ...
                    if (pokerRule_pdk.isLaizi(a, laiziValue) != pokerRule_pdk.isLaizi(b, laiziValue)) {
                        return pokerRule_pdk.isLaizi(a, laiziValue) ? -1 : 1;
                    }
                ...
                paiArr.sort(function (a, b) {
                    ...
                    if (pokerRule_pdk.isLaizi(a, laiziValue) != pokerRule_pdk.isLaizi(b, laiziValue)) {
                        return pokerRule_pdk.isLaizi(a, laiziValue) ? -flag : flag;
                    }
                ...
                TouchUtils.setOnclickListener($("ops.tishi"), function () {
                    ...
                    if (curTishiArr == null)
                        ...
                        if (curTishiArr.length <= curTishiIdx)
                            curTishiIdx = 0;
                        // console.log(JSON.stringify(pokerRule_pdk.numberArr2NameArr(curTishiArr[curTishiIdx])));
        ...
        openJiesuanLayer: function () {
            ...
            setTimeout(function () {
                ...
                switch (gameData.mapId) {
                    ...
                    case MAP_ID.PDK_JBC:
                    case MAP_ID.PDK_MATCH:
                        layer = new PokerJieSuanLayer(that.jieSuanData);
                        break;
                    case MAP_ID.DDZ_JD:
        ...
        biPaiAnim: function (fromRow, row1, row2, cb) {
            ...
            for (var i = 1; i <= 2; i++) {
                ...
                for (var j = 0; j < 3; j++) {
                    ...
                    cards[i].getChildByName('b' + j).setTexture('res/image/ui/poker/unit/pai_back.png');
                }
        ...
        faAllPai: function (cb) {
            ...
            var func = function (i, j, idx) {
                ...
                sprite.setTexture('res/image/ui/poker/unit/pai_back.png');
        ...
        enableBtn: function (btnname) {
            var texture_filename = {
                'ops.qi': 'res/submodules/pdk/image/PkScene/btn_hong.png',
                'ops.bi': 'res/submodules/pdk/image/PkScene/btn_lan.png',
                'ops.jia': 'res/submodules/pdk/image/PkScene/btn_lan.png',
                'ops.gen': 'res/submodules/pdk/image/PkScene/btn_cheng.png',
                'jia.jia2': 'res/submodules/pdk/image/PkScene/btn_lan.png',
                'jia.jia3': 'res/submodules/pdk/image/PkScene/btn_lan.png',
                'jia.jia4': 'res/submodules/pdk/image/PkScene/btn_lan.png',
                'jia.jia5': 'res/submodules/pdk/image/PkScene/btn_lan.png',
                ...
                'btn_jiao1': 'res/submodules/pdk/image/PkScene/btn_lan.png',
                'btn_jiao2': 'res/submodules/pdk/image/PkScene/table/btn_lan.png',
                'btn_jiao3': 'res/submodules/pdk/image/PkScene/btn_lan.png',
