...
(function () {
    var exports = this;
    var $ = null;
    var MatchRewardInGameLayer = cc.Layer.extend(
        {
            ctor: function (data) {
                this._super();
                ...
                var scene=loadNodeCCS(res.MatchRewardInGameLayer_json,this);
                ...
                if (rewardList && rewardList.length > 0) {//胜利
                    ...
                    var lb1=new RichInGameLabel(str1,'Arial',26,null,top,cc.color(255,241,22),20);
                    lb1.setPosition(pos1);
                    $('border.winnode').addChild(lb1);
                    var str2='获得奖励:'+goodsStr;
                    var pos2=$('border.winnode.node2').getPosition();
                    var lb2=new RichInGameLabel(str2,'Arial',26,null,goodsStr,cc.color(255,241,22),20);
                    ...
                    var lb2=new RichInGameLabel(str2,'Arial',26,null,null,null,20);
                    lb2.setPosition(pos2);
            ...
            showRewardPlat:function(recordId,num){
                ...
                var btn_close = new cc.Sprite('res/submodules/pdk_match/img/btnclose.png');
            ...
            showAnim:function(){
                ...
                var spm = new sp.SkeletonAnimation(res.spine_huojiang_InGame_json, res.spine_huojiang_InGame_atlas);
                spm.setAnimation(0, 'huojiang1', false);
                spm.setCompleteListener(function () {
                    var spm2 = new sp.SkeletonAnimation(res.spine_huojiang_InGame_json, res.spine_huojiang_InGame_atlas);
    ...
    exports.MatchRewardInGameLayer = MatchRewardInGameLayer;
})(window);