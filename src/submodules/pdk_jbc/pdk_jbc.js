...
var pdk_jbc_src = [
    //四川跑得快
    // 'src/submodules/pdk_jbc/scpdkRule.js',
    // 'src/submodules/pdk_jbc/SCPokerLayer.js',

    'src/submodules/pdk_jbc/PokerJBCJieSuanLayer.js',
    'src/submodules/pdk_jbc/PokerJBCLayer.js',
    'src/submodules/pdk_jbc/PokerJBCZongJiesuanLayer.js',
    // 'src/submodules/pdk_jbc/WanfaLayer_scpdk.js',
    // 'src/submodules/pdk_jbc/QiepaiLayer.js'
];

var pdk_jbc_res = {
    PkScene_jbc_json: 'res/submodules/pdk_jbc/ccs/PkScene.json',
    PokerJBCJieSuan_json: 'res/submodules/pdk_jbc/ccs/PokerJieSuan.json',
    PokerZongJBCJieSuan_json: 'res/submodules/pdk_jbc/ccs/PokerZongJiesuan.json',
    // PkQiepai_pdk_json: 'res/submodules/pdk_jbc/ccs/QiepaiLayer.json',
    //四川跑得快
...
var pdk_jbc_create_room_tabData = {
    btn_10: {
        click: ['mapid_0'],
        show: [],
        hide: ["word_fd"]
...
var pdk_jbc_create_room_wanFaData = [
    ['mapid', [
