...
(function () {
    ...
    var SSSReplayLayer = cc.Layer.extend({
        curDataIndex: 0,
        onEnter: function () {
        ...
        ctor: function (data) {
            ...
            var that = this;
            replayData = data;
            var scene = loadNodeCCS(res.SSSReplayLayer_json, this, undefined, true);
    ...
    exports.SSSReplayLayer = SSSReplayLayer;
})(window);
